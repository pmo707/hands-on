 ...
 */
public class ExerciseMoodle23 {
    private static final Logger LOG = LoggerFactory.getLogger(ExerciseMoodle23.class);
    ...
    public static void main(String[] args) throws IOException, ExecutionException, InterruptedException {
        try (final SphereClient client = createSphereClient()) {
            ...
            // This time not done in the course.
            // This is the old code!!

            // ToDo: Update code and Moodle task.
            // Use interfaces
            // Use CompletionStage
            // Avoid UUID-customer
